...
class Sound(object):
    def __init__(self):
        ...
        self.channels = 1#MAX_INPUT_CHANNELS
        self.sample_rate = 44100#DEFAULT_SAMPLE_RATE
        self.chunk = 1024#CHUNK_SIZE
        self.duration = 5#DURATION
        self.path = "recorded.wav"#WAVE_OUTPUT_FILE
        self.device = 0#INPUT_DEVICE
        self.frames = []
